...
public class ScreensFramework extends Application {
    ...
    public static boolean PI_Swich=true;
    ...
    public static String screen1File = "GPRS.fxml";
	...
	//@4-主程序显示定时器
	public static GPRS_DisplayTimer GPRS_Displsy;
    ...
    public void start(Stage primaryStage) {
    	...
    	if(PI_Swich==false)
    	screen1File = new String("GPRS.fxml");
    	else if(PI_Swich==true)
    	screen1File = new String("GPRS_PI2.fxml");
...
//		int Net_Recv_ShipNum=(int)(((0x80&0xff)*256)+((0x80&0xff)));
//		System.out.println("d:"+Net_Recv_ShipNum);
        ...
        {
	        Rec_Stage.setX(bounds.getMinX() + bounds.getWidth() / 2 - 800 / 2);
	        Rec_Stage.setY(bounds.getMinY() + bounds.getHeight() / 2 - 480 / 2);
        }
		...
		//@8-启动定时器-200ms		
        GPRS_Displsy = new GPRS_DisplayTimer(20);
    }
